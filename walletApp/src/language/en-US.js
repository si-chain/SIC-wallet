...
const locale = {
    ...
    policy: {
      ...
      upload_nomore_tip: 'Policy Description: click on the "policy hosting" above, you can upload your own insurance documents or pictures, and you can get the reward SIC after the audit.',
      policy_upload_tip_title: 'Reminder',
      policy_upload_tip: "It is recommended to upload an electronic policy document, but it can also be used to take a paper warranty. If the paper policy is on the paper, it is necessary to upload the insurance policy, the insurance product name, the insurer, and the insured's completely clear content.",
      tip_insurance_policy: 'Insurance Policy',
      tip_insurance_claim: 'Insurance Claim',
      history_policy:'Policy History',
