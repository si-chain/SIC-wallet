<template lang="html">
	<div class="sic-scroll" :class="{'down':(state===0),'up':(state==1),refresh:(state===2),touch:touching}" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)">
...
<style lang="less">
	@import url("../style/sicScroll.less");
</style>
<script>
/*eslint-disable */
/* jshint ignore:start */
